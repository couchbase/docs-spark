...
=== Improvements
* [SPARKC-212](https://couchbasecloud.atlassian.net/browse/SPARKC-212):
...
* [SPARKC-209](https://couchbasecloud.atlassian.net/browse/SPARKC-209):
Limits are now pushed down in DataFrame query reads, for a performance improvement.
* [SPARKC-208](https://couchbasecloud.atlassian.net/browse/SPARKC-208):
Move to Spark 3.5.3.
* [SPARKC-207](https://couchbasecloud.atlassian.net/browse/SPARKC-207):
Many improvements to logging, with the most useful lines now logged at INFO rather than DEBUG.

=== Bugs
* [SPARKC-210](https://couchbasecloud.atlassian.net/browse/SPARKC-210):
Fixes a regression introduced with backpressure support in 3.3.4 that caused each query to stream significantly slower.
* [SPARKC-211](https://couchbasecloud.atlassian.net/browse/SPARKC-211):
Fixes a regression introduced with backpressure support in 3.3.4 that caused each query to get executed twice.
* [SPARKC-206](https://couchbasecloud.atlassian.net/browse/SPARKC-206):
Manual partitioning does not interact well with groupBy.
