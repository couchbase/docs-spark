...
From this 4.0.0 release, the Couchbase Spark Connector is changing release models to better accommodate the https://spark.apache.org/versioning-policy.html[upcoming changes to the Apache Spark release model].
...
The source of the Apache support dates is the community site https://endoflife.date/apache-spark[endoflife.date] along with the https://spark.apache.org/versioning-policy.html[Apache Spark versioning policy].
