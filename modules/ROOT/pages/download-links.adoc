...
http://packages.couchbase.com/clients/connectors/spark/3.5.0/Couchbase-Spark-Connector_2.12-3.5.0.zip[Download (Scala 2.12 / Java)^]
| http://packages.couchbase.com/clients/connectors/spark/3.5.0/Couchbase-Spark-Connector_2.13-3.5.0.zip[Download (Scala 2.13 / Java)^]
| http://docs.couchbase.com/sdk-api/couchbase-spark-connector-3.5.0/[API Reference^]
