...
The Couchbase Spark Connector supports any type of Couchbase cluster.  Users of Capella Analytics or Enterprise Analytics should see the xref:enterprise-analytics.adoc[Analytics Support] page.
