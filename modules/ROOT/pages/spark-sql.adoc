...
:description: Spark allows accessing query, analytics, and Capella Columnar in powerful and convenient ways.
...
Note all query options are documented here xref:_query_options[Query Options] and all Capella Columnar options here xref:_columnar_options[Capella Columnar options].
