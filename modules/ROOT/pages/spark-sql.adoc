...
:description: Spark allows accessing query, analytics, Enterprise Analytics, and Capella Analytics, in powerful and convenient ways.
...
.Spark DataFrame Creation by Analytics Service
|===
| Analytics solution | Spark method

a| xref:enterprise-analytics:intro:intro.adoc[Enterprise Analytics]
| `couchbase.enterprise-analytics`

a| xref:analytics:intro:intro.adoc[Capella Analytics] -- _formerly known as Columnar_
| `couchbase.columnar`

a| xref:server:learn:services-and-indexes/services/analytics-service.adoc[CBAS (Couchbase Analytics Service)] -- row-based analytics in operational clusters (self-managed or Capella Operational)
| `couchbase.analytics`
|===
...
----
Scala (Capella Analytics, _a.k.a._ Columnar)::
+
--
[source,scala]
----
...
Note, all query options are documented in xref:_query_options[Query Options], 
all Capella Analytics options in xref:_columnar_options[Capella Analytics options], 
and all Enterprise Analytics options in xref:_enterprise_analytics_options[Enterprise Analytics options].
...
----
PySpark (Capella Analytics, _a.k.a._ Columnar)::
+
[source,python]
----
...
The Spark Connector exposes sub-document KV writes via both xref:working-with-rdds.adoc[RDDs] and xref:subdocument.adoc[DataFrames].
...
| Name of a Couchbase Analytics database
| Mandatory

| "scope"
| ColumnarOptions.Scope
| Name of a Couchbase Analytics scope
| Mandatory

| "collection"
| ColumnarOptions.Collection
| Name of a Couchbase Analytics collection
| Mandatory
...
The following predicates are pushed down to the query, operational analytics, Enterprise Analytics, and Capella Analytics engines if possible:
