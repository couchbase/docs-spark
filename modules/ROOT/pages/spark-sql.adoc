...
In this example, say we are reading from an orders collection, where we know we have around 100,000 orders and want to partition into 100 {sqlpp} statements.  Here we will partition on a numerical "id" column:
```
spark.read
