...
:nav-title: Analytics Support
:page-aliases: columnar.adoc
:description: Connecting to Capella Analytics or Enterprise Analytics cluster is very similar to connecting to any Couchbase cluster. 
...
Capella Analytics or Enterprise Analytics clusters can be connected to using either Scala or PySpark.
...
The first step as usual is to create a `SparkSession`, here connecting to your Capella Analytics or Enterprise Analytics cluster.
...
Note this SQL is executed purely within Spark, and is not sent to the Analytics cluster.
