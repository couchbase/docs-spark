...
[abstract]
To get started with the Couchbase Spark connector quickly with Scala, learn how to add the connector to your Spark project and run simple queries.

This page is for Scala users - Python users should go to the xref:pyspark.adoc[PySpark getting started] guide.
...
Here is a reference to the https://docs.couchbase.com/sdk-api/couchbase-spark-connector-4.0.0/api/com/couchbase/index.html[Scala docs^].
...
(Note if you are using Apache Spark 3.5 then see xref:download-links.adoc[Download Links] for the correct Spark Connector version.  The rest of the guide works unchanged.)
